    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-center items-end px-6 lg:px-[6vw]">
        ...
        >
          ...
          <div className="text-[clamp(42px,8vw,120px)] text-[#FF4D2E]">LESSEN</div>
        </div>
        ...
        <div
          ref={cardRef}
          className="absolute left-[6vw] top-[22vh] w-[90vw] lg:w-[34vw] min-h-[auto] lg:min-h-[56vh] bg-white rounded-[28px] card-shadow p-6 lg:p-8"
        >
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-full bg-[#F6FBF6] flex items-center justify-center flex-shrink-0">
                <Sparkles size={16} className="text-[#FF4D2E]" />
              </div>
              <div>
            ...
            <li className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-full bg-[#F6FBF6] flex items-center justify-center flex-shrink-0">
                <DoorOpen size={16} className="text-[#FF4D2E]" />
              </div>
              <div>
